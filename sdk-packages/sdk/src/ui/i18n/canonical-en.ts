...
const en = {
  ...
  'auth.use_email_code': 'Sign in with a code',
  'auth.resend_code': 'Send the code again',
  ...
  'auth.otp_title': 'Sign in with a code',
  'auth.otp_subtitle': "Enter your email and we'll send you a sign-in code — no password needed.",
  'auth.otp_verify_title': 'Enter the code',
  'auth.otp_verify_subtitle': 'We sent a 6-digit code to your email. Enter it here to sign in.',
  ...
  'auth.signup_sent_subtitle': 'We sent a confirmation link to your email. Click it to activate your account — you will be signed in here automatically.',
  'auth.reset_link_valid': 'The link is valid for 1 hour.',
  'auth.code_resent': 'We sent you a new code.',
  ...
  'support.file_requirements': 'JPEG/PNG/WebP, up to {max} files, ≤ {size}MB each',
  'support.too_many_files': 'Up to {max} files',
  'support.invalid_file': 'Only JPEG/PNG/WebP, ≤ {size}MB each',
