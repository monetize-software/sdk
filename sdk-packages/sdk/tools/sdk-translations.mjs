...
export const SDK_TRANSLATIONS = {
  ...
  'auth.rate_limited': {
    ...
    uk: 'Забагато запитів. Спробуйте за хвилину.',
    de: 'Zu viele Anfragen. Bitte versuchen Sie es gleich erneut.',
    es: 'Demasiadas solicitudes. Inténtalo en un momento.',
    fr: 'Trop de requêtes. Réessayez dans un instant.',
    it: 'Troppe richieste. Riprova tra un momento.',
    pt: 'Muitas solicitações. Tente novamente em um momento.',
    pl: 'Zbyt wiele żądań. Spróbuj za chwilę.',
    cs: 'Příliš mnoho požadavků. Zkuste to za chvíli.',
    hu: 'Túl sok kérés. Próbálja meg hamarosan újra.',
    ro: 'Prea multe cereri. Încearcă din nou în câteva momente.',
    nl: 'Te veel verzoeken. Probeer het zo opnieuw.',
    sv: 'För många förfrågningar. Försök igen om en stund.',
    da: 'For mange anmodninger. Prøv igen om lidt.',
    no: 'For mange forespørsler. Prøv igjen om litt.',
    fi: 'Liian monta pyyntöä. Yritä hetken kuluttua uudelleen.',
    el: 'Πολλά αιτήματα. Δοκιμάστε ξανά σε λίγο.',
    tr: 'Çok fazla istek. Lütfen biraz sonra tekrar deneyin.',
    id: 'Terlalu banyak permintaan. Coba lagi sebentar lagi.',
    ar: 'طلبات كثيرة جدًا. حاول مرة أخرى بعد قليل.',
    ja: 'リクエストが多すぎます。少し時間をおいて再試行してください。',
    ko: '요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.',
    zh: '请求过多，请稍后再试。',
    hi: 'बहुत अधिक अनुरोध। कुछ देर बाद पुनः प्रयास करें।',
    th: 'มีคำขอมากเกินไป โปรดลองอีกครั้งในไม่ช้า',
    vi: 'Quá nhiều yêu cầu. Vui lòng thử lại sau giây lát.',
    he: 'יותר מדי בקשות. נסה שוב בעוד רגע.'
  },
  'auth.network_error': {
